...
// 音效文件路径
const sound = {
  bgm: new Audio('music/闯关背景音乐.mp3'),
  success: new Audio('music/闯关成功音效.wav'),
  fail: new Audio('music/闯关失败音效.mp3'),
  right: new Audio('music/答对表扬音.mp3'),
  wrong: new Audio('music/答错提示音.wav'),
  coin: new Audio('music/金币获得音效.mp3'),
};
sound.bgm.loop = true;
